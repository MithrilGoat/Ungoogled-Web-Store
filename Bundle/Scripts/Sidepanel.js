...
// Source/Sidepanel/Component.tsx
function Component() {
  const [text, setText] = h2("Before Click");
  const click = () => {
    setText("After Click");
  };
...
// Source/Sidepanel/App.tsx
function hookApp() {
  B(/* @__PURE__ */ u3(Component, {}, undefined, false, undefined, this), document.body);
}

// Source/Sidepanel/mod.ts
hookApp();
