...
var MutationCache = class extends Subscribable {
  ...
  remove(mutation2) {
    ...
    if (this.#mutations.has(scope)) {
      const mutations = this.#mutations.get(scope)?.filter((x) => x !== mutation2);
      if (mutations) {
  ...
  canRun(mutation2) {
    const firstPendingMutation = this.#mutations.get(scopeFor(mutation2))?.find((m) => m.state.status === "pending");
    return !firstPendingMutation || firstPendingMutation === mutation2;
  }
  runNext(mutation2) {
    const foundMutation = this.#mutations.get(scopeFor(mutation2))?.find((m) => m !== mutation2 && m.state.isPaused);
  ...
  resumePausedMutations() {
    ...
    return notifyManager.batch(() => Promise.all(pausedMutations.map((mutation2) => mutation2.continue().catch(noop))));
  }
};
...
var QueryObserver = class extends Subscribable {
  ...
  fetchOptimistic(options) {
    ...
    query3.isFetchingOptimistic = true;
...
var QueryClientProvider = ({
  ...
  return /* @__PURE__ */ jsx_runtime.jsx(QueryClientContext.Provider, { value: client, children });
};
...
// Source/Sidepanel/Query.tsx
function Provider(args) {
  return /* @__PURE__ */ u2(QueryClientProvider, {
    client,
    ...args
...
function w2(n2) {
  var t2, r2 = function() {
    clearTimeout(u3), k2 && cancelAnimationFrame(t2), setTimeout(n2);
  }, u3 = setTimeout(r2, 100);
  k2 && (t2 = requestAnimationFrame(r2));
}
function z2(n2) {
  var t2 = r2, u3 = n2.__c;
  typeof u3 == "function" && (n2.__c = undefined, u3()), r2 = t2;
}
function B2(n2) {
  var t2 = r2;
  n2.__c = n2.__(), r2 = t2;
...
// Source/Sidepanel/Extensions.ts
function useExtensionInfos() {
  const client2 = useQueryClient();
  y2(() => {
    const invalidate = () => client2.invalidateQueries({
      queryKey: Key,
      exact: true
    });
...
var { management } = chrome;
var Key = ["Extension", "Info"];
...
function Component() {
  ...
  return /* @__PURE__ */ u2("div", {
    children: infos.data?.length ?? "test"
  }, undefined, false, undefined, this);
}

// Source/Sidepanel/App.tsx
function Root() {
  return /* @__PURE__ */ u2(Provider, {
    children: /* @__PURE__ */ u2(Component, {}, undefined, false, undefined, this)
  }, undefined, false, undefined, this);
}
function hookApp() {
  B(/* @__PURE__ */ u2(Root, {}, undefined, false, undefined, this), document.body);
}
